...
<html>
	...
	<body style="background-color:powderblue;">
		...
		<h1 align="center">Welcome to Online Auction Bay Website</h1>
		<div class="container">
			<h2 align="center">Customer Representative Options:</h2>
			<%
			...
			<div style="background-color:lightblue" class="row">
				<div style="background-color:lightblue" class="col">
					<div style="background-color:lightslategray" class="card">
					  <div class="card-body">
					    <h5 style="color:#FFD700;" class="card-title">Record a Sale</h5>
    					<div class="container">
				...
				<div class="col">
					<div style="background-color:lightslategray" class="card">
					  <div class="card-body">
					    <h5 style="color:#FFD700;" class="card-title">Manage Customer</h5>
    					<div class="container">
				...
				<div class="col">
					<div style="background-color:lightslategray" class="card">
					  <div class="card-body">
					    <h5 style="color:#FFD700;" class="card-title">View Customer Mailing List</h5>
    					<div class="container">
				...
				<div class="col">
					<div style="background-color:lightslategray" class="card">
					  <div class="card-body">
					    <h5 style="color:#FFD700;" class="card-title">View Suggestions for Customers</h5>
    					<div class="container">
